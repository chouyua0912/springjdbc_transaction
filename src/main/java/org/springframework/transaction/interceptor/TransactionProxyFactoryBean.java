...
/**
 * Proxy factory bean for simplified declarative transaction handling.                      处理xml配置文件类型的事务代理
 ...
 *
 * <pre code="class">                                                       通过定义抽象bean，子bean继承
 * {@code
 ...
 * @see org.springframework.aop.framework.ProxyFactoryBean  // 通用的生成Proxy的FactoryBean实现类，TransactionProxyFactoryBean是事务特化的FactoryBean
 */
