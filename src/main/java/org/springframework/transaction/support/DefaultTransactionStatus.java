...
public class DefaultTransactionStatus extends AbstractTransactionStatus {
    ...
    private final Object transaction;           // 保存事务对象 DataSourceTransactionManger.DataSourceTransactionObject

    private final boolean newTransaction;       // 标记是否为新事务 连同TransactionSynchronizationManager状态来控制newSynchronization的值

    private final boolean newSynchronization;   // 控制是否要通过 TransactionSynchronizationManager 绑定到线程变量

    private final boolean readOnly;

    private final boolean debug;

    private final Object suspendedResources;    // 记录被本事务挂起的事务资源
