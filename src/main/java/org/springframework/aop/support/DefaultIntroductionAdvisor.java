...
public class DefaultIntroductionAdvisor implements IntroductionAdvisor, ClassFilter, Ordered, Serializable {
    ...
    /**
     * Create a DefaultIntroductionAdvisor for the given advice.    构造的时候需要提供Advice
     ...
     */
    public DefaultIntroductionAdvisor(Advice advice, IntroductionInfo introductionInfo) {       // 需要提供Advice和
