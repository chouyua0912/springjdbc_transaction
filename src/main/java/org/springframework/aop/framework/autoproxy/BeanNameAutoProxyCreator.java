...
/**
 * Auto proxy creator that identifies beans to proxy via a list of names.       检查bean名字，自动匹配生成Aop代理
 * Checks for direct, "xxx*", and "*xxx" matches.                               实现了BeanPostProcessor，没有实现Advisor和Pointcut
 *
