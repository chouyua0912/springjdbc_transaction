...
public class ProxyCreatorSupport extends AdvisedSupport {
    ...
    private AopProxyFactory aopProxyFactory;    // 持有AopProxy工厂 DefaultAopProxyFactory,会根据AdvisedSupport配置决定使用JDK还是CGlib来创建代理实例
    ...
    public ProxyCreatorSupport() {
        this.aopProxyFactory = new DefaultAopProxyFactory();        // 首先会初始化Aop工厂类
    }
