...
public abstract class DataSourceUtils {
    ...
    public static Connection doGetConnection(DataSource dataSource) throws SQLException {
        ...
        // Else we either got no holder or an empty thread-bound holder here. 没有线程绑定conn，或者是空
    ...
    public static Integer prepareConnectionForTransaction(Connection con, TransactionDefinition definition)
        ...
        // Set read-only flag.
        if (definition != null && definition.isReadOnly()) {    // 设置conn为只读 readonly
            try {
        ...
        if (definition != null && definition.getIsolationLevel() != TransactionDefinition.ISOLATION_DEFAULT) {
            ...
            int currentIsolation = con.getTransactionIsolation();       // 设置隔离级别 isolation
