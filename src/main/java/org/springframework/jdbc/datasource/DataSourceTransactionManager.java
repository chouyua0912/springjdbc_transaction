...
public class DataSourceTransactionManager extends AbstractPlatformTransactionManager
    ...
    protected Object doGetTransaction() {
        ...
        ConnectionHolder conHolder =    // TransactionManager里注入了dataSource
    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        try {
            if (!txObject.hasConnectionHolder() ||      // 没有绑定线程连接，或者已经
            ...
            if (con.getAutoCommit()) {      // 改为手动commit
            ...
            if (txObject.isNewConnectionHolder()) {     // 新的连接需要绑定到线程并激活
                TransactionSynchronizationManager.bindResource(getDataSource(), txObject.getConnectionHolder());    // 完成conn设置，注册到线程变量上
            }
        }
